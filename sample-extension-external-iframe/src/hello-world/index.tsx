...
export const Component = component({
  componentTypeId: 'helloAgainWorld', // This is the id for your component in our system, must be camelCase. It is used to reference the component in places like templates
