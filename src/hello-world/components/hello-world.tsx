    ...
    <>
      <div id='chat-test'
        dangerouslySetInnerHTML={{
          __html: `<div style="position:fixed;bottom:15px;right:3%;z-index:1;">
             
            <div id="main-chat-div" style="overflow: auto; position:relative; bottom: 0px; z-index:2; background: ${buttonColor}; border-radius:25px;box-shadow: rgb(0 0 0 /35%) 0px 2px 2px; transition: all .15s" onclick="animateChats()" onmouseover= "animateBubbleIn(this)" onmouseleave="animateBubbleOut(this)">
              <span style = "position:relative; float: left; padding-left: 20px; padding-top: 7px;">
              ...
              <span id = "button-text" style = "position:relative; padding-left: 11px; padding-right: 11px; top: 12px; right: 3px; color: ${buttonTextColor}; font-weight: 600">${buttonText}</span>
            </div>
           
            <div id="whatsappchat-div" style = "width: 60px; height: 60px; background: #4CC147; opacity:0; border-radius:50%; position:absolute; top:0px; right: 0px; z-index:1; box-shadow: rgb(0 0 0 /45%) 0px 0px 10px; transition: all .25s; transform: scale(.7)" onmouseover= "animateBubbleIn(this)" onmouseleave="animateBubbleOut(this)">
            ...
            <div id="telegram-div" style = "width: 60px; height: 60px; background: #0189CB; opacity:0; border-radius:50%; position:absolute; top: 0px; right: 0px; z-index:1; box-shadow: rgb(0 0 0 /45%) 0px 0px 10px; transition: all .25s; transform: scale(.7)" onmouseover= "animateBubbleIn(this)" onmouseleave="animateBubbleOut(this)">
        ...
        dangerouslySetInnerHTML={{
          ...
          function animateChats() {
            ...
            if (expanded == 0) {
                ...
                document.getElementById("main-chat-div").style.transform = "scale(.7)"
