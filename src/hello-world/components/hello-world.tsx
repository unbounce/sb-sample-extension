      ...
      <div id='chat-test'
        dangerouslySetInnerHTML={{
          __html: `<div style="position:fixed;bottom:15px;right:3%;z-index:1;">
            ...
            <div id="main-chat-div" style="width: 60px; height: 60px; position:relative; bottom: 0px; z-index:2; background: ${buttonColor}; border-radius:50%;box-shadow: rgb(0 0 0 /35%) 0px 2px 2px; transition: all .15s" onclick="animateChats()" onmouseover= "animateBubbleIn(this)" onmouseleave="animateBubbleOut(this)">
              ...
              <svg id='main-chat-open' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' viewBox='-9 -9 41 41' style='width: 100%; height: 100%; fill: rgb(255, 255, 255); stroke: none; opacity:0; position:absolute; left -1px; transition: all .25s'><path d=' M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z'></path></svg>
               <span>${buttonTest}</span>
            </div>
           
            <div id="whatsappchat-div" style = "width: 60px; height: 60px; background: #4CC147; opacity:0; border-radius:50%; position:absolute; top:0px; z-index:1; box-shadow: rgb(0 0 0 /45%) 0px 0px 10px; transition: all .25s; transform: scale(.7)" onmouseover= "animateBubbleIn(this)" onmouseleave="animateBubbleOut(this)">
            ...
            <div id="telegram-div" style = "width: 60px; height: 60px; background: #0189CB; opacity:0; border-radius:50%; position:absolute; top: 0px; z-index:1; box-shadow: rgb(0 0 0 /45%) 0px 0px 10px; transition: all .25s; transform: scale(.7)" onmouseover= "animateBubbleIn(this)" onmouseleave="animateBubbleOut(this)">
      ...
      <script type="text/javascript"
        dangerouslySetInnerHTML={{
          ...
          function animateBubbleOut(obj) {
            ...
            if (expanded == 0) {obj.style.transform = "scale(1)"}
          }`
        }}
      />
    </>
